...
The slice center position is controlled via numerical input along each
axis in the original command \texttt{SliceDynamic}. This provides
numerical feedback on the position of the center. For easier navigation
but without the numerical feedback, an implementation of the slice
center control via a visual display like the one in Figure
\ref{fig:anchornav} is provided in \texttt{SliceDynamicCC}.
