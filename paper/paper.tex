...
visualisation appears on the right. The user can change the orientation
...
data that has been centred and scaled. The projected data can be
...
the slice, similarly to how the manual tour was implemented here. An
...
\ref{proj1} summarises the process. Rotating manually the view, we can
visualise the location of predictions for each of the three species, and
