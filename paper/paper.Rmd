...
The problem with Algorithm 1 is that the precise values for $V_m$ cannot be specified because the orthonormalisation will change them. This modification will maintain the components of $V_m$ precisely (Figure \ref{fig:manualsequence} (bottom row)). The algorithm is as follows:
