...
The authors gratefully acknowledge the support of the Australian Research Council. The paper was written in `rmarkdown` [@rmarkdown] using `knitr` [@knitr]. The scatterplot matrix of the penguins data was produced by the GGally [@GGally] package built on ggplot2 [@ggplot2] graphics.
