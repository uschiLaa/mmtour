...
\caption{Shifting the slice center allows for exploring the boundary in different subspaces. Here the center has been shifted out along the axis of bill depth (icon display at right represents slice center position). This region has no Gentoo. The two models have similar boundaries except that the RF is has a step shift in the middle.}
\label{slice1p}
\end{figure*}
