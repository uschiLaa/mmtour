...
a form of star plot as suggested useful in
\textcolor{red}{REF to Catherine's paper}, where the position of the
point is marked by a polygon on radial axes indicating its position
relative to the variable minimum to maximum values.
